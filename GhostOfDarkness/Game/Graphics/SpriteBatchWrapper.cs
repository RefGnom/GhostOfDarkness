...
public class SpriteBatchWrapper : SpriteBatch, ISpriteBatch
{
    ...
    public void Draw(Texture2D texture, Vector2 position, Vector2 origin, Vector2 scale, float layerDepth)
    {
        Draw(texture, position, null, Color.White, 0, origin, scale, SpriteEffects.None, layerDepth);
    }
}